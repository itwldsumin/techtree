...
<div class="page-wrapper">
	<div class="page-inner">
		...
		<div class="info-card">
			...
			<div class="info-card-text">
				...
				<a href="#" class="d-flex align-items-center text-white"> <span
					class="text-truncate text-truncate-sm d-inline-block"> 안녕하세요
						${login.memName}님 </span>
		...
		<ul id="js-nav-menu" class="nav-menu">
			<li><a href="/" title="Application Intel"
				data-filter-tags="application intel"> <i
					...
					data-i18n="nav.application_intel"> 문의 목록 </span>
			</a></li>
		...
		<div class="page-content-wrapper">
			...
			<span class="page-logo-text mr-1">테크트리</span>
			<div class="page-logo">
				<a href="#"
					class="page-logo-link press-scale-down d-flex align-items-center position-relative"
					data-toggle="modal" data-target="#modal-shortcut"> <img
					...
					class="page-logo-text mr-1">테크트리</span> <span
					class="position-absolute text-white opacity-50 small pos-top pos-right mr-2 mt-n2"></span>
			...
			<!-- DOC: nav menu layout change shortcut --> <!-- DOC: mobile button appears during mobile width -->
			<span class="page-logo-text mr-1">테크트리</span>
			<div class="page-logo">
				<a href="#"
					class="page-logo-link press-scale-down d-flex align-items-center position-relative"
