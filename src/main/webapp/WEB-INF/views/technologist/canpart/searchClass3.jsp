			...
			<div class="row">
				<div class="form-row col-md-12">
					<div class="form-group col-md-12">
						<div class="label m10">
							<label for="inputEmail4">전체 활용 분야 리스트 </label>
						</div>
						<div class='box-body'>
							...
							<form action="searchClass3" method="get"
								...
								<div class="input-group">
									<input type="text" class="form-control" id="class3Name"
										name="class3Name" placeholder="항목명을 검색해주세요.">
					...
					<div class="table-responsive">
						<table class="table table-centered mb-0">
							...
							<tbody>
								<c:if test="${!empty searchClass3}">
									<c:forEach items="${searchClass3}" var="Class3VO"
										varStatus="listStat">
										<tr>
