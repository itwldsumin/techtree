...
<link id="appbundle" rel="stylesheet" media="screen, print"
   href="/resources/dist/app.bundle.css">
      ...
      <div id="header">
         ...
         <ul>
            ...
            <li><c:if test="${techLogin.techId ne null}"> ${techLogin.techName}님 반갑습니다</c:if>
               <c:if test="${login.memId ne null}"> ${login.memName}님 반갑습니다</c:if>
            </li>
            <li><c:if
                  test="${login.memId eq null and login.memId ne null and techLogin.techId eq null }">
                  <a href="/member/myPage" title="내정보">내정보</a>
               </c:if> <c:if
                  test="${techLogin.techId ne null and login.memId eq null or login.memId ne null  }">
               ...
               function() {
                  ...
                  checkbox
                        ...
                        .each(function() {
                           ...
                           var row = "<tr>"
                                 + "<td>"
                                 + "<input type=\"checkbox\" class=\"checkBox2\" name=\"check2\" value=\"" + memId + "\"" + ">"
                                 + "</td>" + "<td>" + class3Name
                                 + "</td>" + "</tr>";
