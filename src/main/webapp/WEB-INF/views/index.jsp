   ...
   <div id="wrap">
      ...
      <div id="header">
         ...
         <ul>
            ...
            <li><c:if test="${techLogin.techId ne null}"> ${techLogin.techName}님 반갑습니다</c:if>
               <c:if test="${login.memId ne null}"> ${login.memName}님 환영합니다.</c:if>
            </li>
            <li> <c:if
                  test="${login.memId ne null }">
      ...
      <div id="container">
         <div id="nav">
            <div class="treeMenuBox">
               <ul class="treeMenu">
                  <li><a href="javascript:subPopup('EE','EE94')" title="정보통신"><em></em>정보통신</a></li>
                  <li><a href="javascript:subPopup('NC','NC01')" title="화학"><em></em>화학</a></li>
                  
                  <li><a href="javascript:subPopup('NB','NB05')" title="물리학"><em></em>물리학</a></li>
                  
                  <li><a href="#" ><em></em></a></li>
                  
                  <li><a href="javascript:subPopup('ND','ND96')" title="천문"><em></em>천문</a></li>
                  <li></li>
                  <li><a href="javascript:subPopup('EF','EF06')" title="에너지"><em></em>에너지</a></li>
                  
                  <li><a href="javascript:subPopup('EA','EA04')" title="기계"><em></em>기계</a></li>
                  <li><a href="javascript:subPopup('LA','LA91')" title="생명과학"><em></em>생명과학</a></li>
                 <!--  <li><a href="javascript:subPopup('ND','ND96')" title="천문"><em></em>생명과학</a></li> -->
         ...
         <div class="layerContents">
            <ul class="lnb">
               <c:forEach items="${list2}" var="Class2VO">
                  <li><a
                     href="javascript:sub2Popup('${Class2VO.class1No}','${Class2VO.class2No}')"
                     class="
                     ...
                     <c:forEach items="${listT}" var="TechList" varStatus="status">
                        <c:forEach items="${TechList}" var="TechnologistVO">
                           <div class="item">
                              ...
                              <c:if test="${login.memId ne null and login.memId eq null  or techLogin.techId eq null }">
                                 <a
                                    href="/member/technologist/read?techId=${TechnologistVO.techId}"
                                    title="${TechnologistVO.intro}">${TechnologistVO.intro}</a>
                              </c:if>
                              <c:if test="${login.memId eq null and login.memId ne null or techLogin.techId ne null }">


                                 <a
                                    href="/technologist/QnA/techRead?techId=${TechnologistVO.techId}"
                                    title="${TechnologistVO.intro}">${TechnologistVO.intro}</a>
