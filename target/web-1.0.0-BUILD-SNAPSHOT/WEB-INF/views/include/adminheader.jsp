	...
	<div class="page-inner">
		...
		<div class="page-logo">
			<a href="#"
				...
				src="/resources/dist/img/logo.png" alt="SmartAdmin WebApp"
				aria-roledescription="logo"> <span class="page-logo-text mr-1">테크트리</span>
				<span
				class="position-absolute text-white opacity-50 small pos-top pos-right mr-2 mt-n2"></span>

			</a>
		</div>
		<!-- BEGIN PRIMARY NAVIGATION --> <nav id="js-primary-nav"
			class="primary-nav" role="navigation">


		<div class="info-card">
			<img src="/resources/dist/img/demo/avatars/avatar-admin.png"
			...
			<div class="info-card-text">
				...
				<a href="#" class="d-flex align-items-center text-white"> <span
					class="text-truncate text-truncate-sm d-inline-block"> 관리자님
				</span>

				</a> <a href="/logout" class="d-flex text-white"><span>Logout</span></a>
			</div>
			<img src="/resources/dist/img/card-backgrounds/cover-2-lg.png"
				class="cover" alt="cover"> </a>
		</div>
		<ul id="js-nav-menu" class="nav-menu">
			<li><a href="/" title="Application Intel"
				data-filter-tags="application intel"> <i
					...
					data-i18n="nav.application_intel"> 과학기술인 관리 </span>
			</a></li>
			<li><a href="#" title="Theme Settings"
				data-filter-tags="theme settings"> <i class="fal fa-cog"></i> <span
					class="nav-link-text" data-i18n="nav.theme_settings">회원 관리
						</span>
			</a></li>
			<li><a href="#" title="Documentation"
				data-filter-tags="documentation"> <i class="fal fa-book"></i> <span
					class="nav-link-text" data-i18n="nav.documentation">기초 정보 관리</span>
			</a></li>
		</ul>
		</aside>
		...
		<div class="page-content-wrapper">
			<!-- BEGIN Page Header -->
			<header class="page-header" role="banner"> <!-- we need this logo when user switches to nav-function-top -->
						...
						<div class="custom-scroll h-100">
							<ul class="app-list">
								...
								<li class="w-100"><a href="#"
									class="btn btn-default mt-4 mb-2 pr-5 pl-5"> Add more apps
								</a></li>
							</ul>
						</div>
					</div>
									...
									<ul class="notification">
										<li class="unread"><a href="#"
											class="d-flex align-items-center"> <span
												class="status mr-2"> <span
													...
													style="background-image: url('/resources/dist/img/demo/avatars/avatar-c.png')"></span>
										...
										<li class="unread"><a href="#"
											class="d-flex align-items-center"> <span
												class="status mr-2"> <span
													class="profile-image rounded-circle d-inline-block"
													style="background-image: url('/resources/dist/img/demo/avatars/avatar-a.png')"></span>
											</span> <span class="d-flex flex-column flex-1 ml-1"> <span
										...
										<li><a href="#" class="d-flex align-items-center"> <span
												class="status status-success mr-2"> <span
													class="profile-image rounded-circle d-inline-block"
													style="background-image: url('/resources/dist/img/demo/avatars/avatar-b.png')"></span>
											</span> <span class="d-flex flex-column flex-1 ml-1"> <span
										...
										<li><a href="#" class="d-flex align-items-center"> <span
												class="status status-warning mr-2"> <span
													class="profile-image rounded-circle d-inline-block"
													style="background-image: url('/resources/dist/img/demo/avatars/avatar-e.png')"></span>
											</span> <span class="d-flex flex-column flex-1 ml-1"> <span
										...
										<li><a href="#" class="d-flex align-items-center"> <span
												class="status status-success mr-2"> <!-- <img src="/resources/dist/img/demo/avatars/avatar-m.png" data-src="/resources/dist/img/demo/avatars/avatar-h.png" class="profile-image rounded-circle" alt="Sarah McBrook" /> -->
													<span class="profile-image rounded-circle d-inline-block"
													style="background-image: url('/resources/dist/img/demo/avatars/avatar-h.png')"></span>
											</span> <span class="d-flex flex-column flex-1 ml-1"> <span
										...
										<li><a href="#" class="d-flex align-items-center"> <span
												class="status status-success mr-2"> <span
													class="profile-image rounded-circle d-inline-block"
													style="background-image: url('/resources/dist/img/demo/avatars/avatar-m.png')"></span>
											</span> <span class="d-flex flex-column flex-1 ml-1"> <span
										...
										<li><a href="#" class="d-flex align-items-center"> <span
												class="status status-danger mr-2"> <span
													class="profile-image rounded-circle d-inline-block"
													style="background-image: url('/resources/dist/img/demo/avatars/avatar-j.png')"></span>
											</span> <span class="d-flex flex-column flex-1 ml-1"> <span
							...
							<div class="tab-pane" id="tab-feeds" role="tabpanel">
								<div class="custom-scroll h-100">
									<ul class="notification">
										...
										<li>
											<div class="d-flex align-items-center show-child-on-hover">
												<!--<img src="/resources/dist/img/demo/avatars/avatar-m.png" data-src="/resources/dist/img/demo/avatars/avatar-k.png" class="profile-image rounded-circle" alt="k" />-->
												<div class="d-flex flex-column flex-1">
													...
													<div class="fs-sm d-flex align-items-center mt-2">
														<span
															...
															style="background-image: url('/resources/dist/img/demo/avatars/avatar-a.png'); background-size: cover;"></span>
														<span
															class="profile-image-md mr-1 rounded-circle d-inline-block"
															style="background-image: url('/resources/dist/img/demo/avatars/avatar-b.png'); background-size: cover;"></span>
														<span
															class="profile-image-md mr-1 rounded-circle d-inline-block"
															style="background-image: url('/resources/dist/img/demo/avatars/avatar-c.png'); background-size: cover;"></span>
														<span
															class="profile-image-md mr-1 rounded-circle d-inline-block"
															style="background-image: url('/resources/dist/img/demo/avatars/avatar-e.png'); background-size: cover;"></span>
														<div data-hasmore="+3"
															class="rounded-circle profile-image-md mr-1">
															<span
																class="profile-image-md mr-1 rounded-circle d-inline-block"
																style="background-image: url('/resources/dist/img/demo/avatars/avatar-h.png'); background-size: cover;"></span>
														</div>
													</div>
										...
										<li>
											<div class="d-flex align-items-center show-child-on-hover">
												<!--<img src="/resources/dist/img/demo/avatars/avatar-m.png" data-src="/resources/dist/img/demo/avatars/avatar-e.png" class="profile-image-sm rounded-circle align-self-start mt-1" alt="k" />-->
												<div class="d-flex flex-column flex-1">
												...
												<div class="d-flex flex-column flex-1">
													...
													<div class="fs-sm d-flex align-items-center mt-1">
														<a href="#" class="mr-1 mt-1" title="Cell A-0012"> <span
															...
															style="background-image: url('/resources/dist/img/thumbs/pic-7.png'); background-size: cover;"></span>
														</a> <a href="#" class="mr-1 mt-1"
															title="Patient A-473 saliva"> <span
															class="d-block img-share"
															style="background-image: url('/resources/dist/img/thumbs/pic-8.png'); background-size: cover;"></span>
														</a> <a href="#" class="mr-1 mt-1"
															title="Patient A-473 blood cells"> <span
															class="d-block img-share"
															style="background-image: url('/resources/dist/img/thumbs/pic-11.png'); background-size: cover;"></span>
														</a> <a href="#" class="mr-1 mt-1"
															title="Patient A-473 Membrane O.C"> <span
															class="d-block img-share"
															style="background-image: url('/resources/dist/img/thumbs/pic-12.png'); background-size: cover;"></span>
														</a>
													</div>
													<span class="fs-nano text-muted mt-1">55 minutes ago</span>
												</div>
										...
										<li>
											<div class="d-flex align-items-center show-child-on-hover">
												<!--<img src="/resources/dist/img/demo/avatars/avatar-m.png" data-src="/resources/dist/img/demo/avatars/avatar-h.png" class="profile-image rounded-circle align-self-start mt-1" alt="k" />-->
												<div class="d-flex flex-column flex-1">
													<div class="name mb-2">
					...
					<div class="dropdown-menu dropdown-menu-animated dropdown-lg">
						<div
							...
							<div
								...
								<span class="mr-2"> <img
									src="/resources/dist/img/demo/avatars/avatar-admin.png"
						...
						<a href="#" class="dropdown-item" data-action="app-fullscreen">
							...
							data-i18n="drpdwn.print">Print</span> <i
						...
						<div class="dropdown-multilevel dropdown-multilevel-left">
							...
							<div class="dropdown-menu">
								<a href="#?lang=fr" class="dropdown-item" data-action="lang"
									...
									class="dropdown-item active" data-action="lang" data-lang="en">English
									(US)</a> <a href="#?lang=es" class="dropdown-item"
									data-action="lang" data-lang="es">Español</a> <a
									href="#?lang=ru" class="dropdown-item" data-action="lang"
