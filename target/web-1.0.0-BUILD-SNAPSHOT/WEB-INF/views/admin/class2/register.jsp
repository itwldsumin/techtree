	...
	<div class="row">
		<div class="col-xl-6">
			<div id="panel-1" class="panel">
				...
				<input type="hidden" id="Class2VO" name="Class2VO" />
					...
					<div class="panel-container show">
						<div class="panel-content">
							...
							<select class="form-control select2" name="class1No"
								id="class1No">
							
								<c:forEach items="${listClass1}" var="Class1VO" >
								
									<option value="${Class1VO.class1No}">${Class1VO.class1Name}</option>
								</c:forEach>
...
<!-- 
							<button
								...
								aria-expanded="false">대분류 선택하기</button>
