	...
	<div id="wrap">
		<div id="container">
			...
			<div id="contain">
				<div class="row">
					<div class="col-xl-12">
						<h3 class="fs-xxl fw-500 mt-4 text-center">과학기술인 정보 수정</h3>
					</div>
					...
					<div class="col-xl-10 ml-auto mr-auto">
						<div class="card p-4 rounded-plus bg-faded">
							...
							<form role="form" name="frm" method="post"
								...
								<div class="form-group">
									<label class="form-label" for="simpleinput">과학기술인 비밀번호</label>
									<input type="text" class="form-control " name="techPW"
										id="techPW" value="${technologistVO.techPW} "
										readonly="readonly">
								</div>
								<div class="form-group">
									<label class="form-label" for="simpleinput">이름</label> <input
										type="text" class="form-control " name="techName"
										id="techName" value="${technologistVO.techName} ">
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									<label class="form-label" for="simpleinput">꿈(어린시절,
										지금), 제일 재미 있어 하는 개발">꿈(어린시절, 지금), 제일 재미 있어 하는 개발</label> <input
										type="text" class="form-control " name="video1" id="video1"
										value="${technologistVO.video1}">
								</div>
								<div class="form-group">
									<label class="form-label" for="simpleinput">주 개발 및 성과</label> <input
										type="text" class="form-control " name="video2" id="video2"
										value="${technologistVO.video2}">
								</div>
								<div class="form-group">
									<label class="form-label" for="simpleinput">협업, 컨설팅
										가능분야</label> <input type="text" class="form-control " name="video3"
								...
								<div class="form-group">
									<label class="form-label" for="simpleinput">스케줄 링크</label> <input
										...
										readonly="readonly" value='${technologistVO.schedule}'>
								</div>


								<div class="form-group">
									<label class="form-label" for="example-textarea">소개글 한
										줄</label>
									<textarea class="form-control " rows="5" name="intro"
										id="intro">${technologistVO.intro}</textarea>
								</div>
													...
													<div id='mydropzone' class="dropzone needsclick"
														...
														<div class="dz-message needsclick fileDrop">
															...
															<span class="text-uppercase">Drop files here or
																click to upload.</span> <br> <span
																class="fs-sm text-muted">This is just a demo
...
<script>
	$(document).ready(function() {
		...
		$("#btn_submit").on("click", function() {
			formObj.attr("action", "/technologist/modify");
