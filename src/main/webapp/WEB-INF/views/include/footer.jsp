			...
			<div
				...
				<div
					...
					<span class="mr-2"> <span
						...
						style="background-image: url('/resources/dist/img/demo/avatars/avatar-d.png'); background-size: cover;"></span>
					</span>
								...
								<li><a href="#"
									...
									data-filter-tags="ali amdaney online">
										<div
											class="d-table-cell align-middle status status-success status-sm ">
											<span class="profile-image-md rounded-circle d-block"
												style="background-image: url('/resources/dist/img/demo/avatars/avatar-g.png'); background-size: cover;"></span>
										</div>
										<div class="d-table-cell w-100 align-middle pl-2 pr-2">
											<div class="text-truncate text-truncate-md">
												Ali Amdaney <small
								...
								<li><a href="#"
									...
									data-filter-tags="ali amdaney busy">
										<div
											...
											<span class="profile-image-md rounded-circle d-block"
												style="background-image: url('/resources/dist/img/demo/avatars/avatar-j.png'); background-size: cover;"></span>
										</div>
										<div class="d-table-cell w-100 align-middle pl-2 pr-2">
											<div class="text-truncate text-truncate-md">
												oliver.kopyuv@gotbootstrap.com <small
													class="d-block font-italic fs-xs text-danger"> Busy
												</small>
											</div>
										</div>
								</a></li>
								...
								<li><a href="#"
									...
									data-filter-tags="ali amdaney inactive">
										<div class="d-table-cell align-middle">
											<span class="profile-image-md rounded-circle d-block"
												style="background-image: url('/resources/dist/img/demo/avatars/avatar-m.png'); background-size: cover;"></span>
										</div>
										<div class="d-table-cell w-100 align-middle pl-2 pr-2">
											<div class="text-truncate text-truncate-md">
												+714651347790 <small
				...
				<div class="settings-panel">
					...
					<div class="list" id="fh">
						<a href="#" onclick="return false;" class="btn btn-switch"
							...
							class="onoffswitch-title-desc">header is in a fixed at all
							times</span>
					</div>
					...
					<div class="list" id="mmb">
						<a href="#" onclick="return false;" class="btn btn-switch"
							...
							class="onoffswitch-title-desc">Encapsulates to a container</span>
					</div>
					<div class="expanded">
						<ul class="mb-3 mt-1">
							<li>
					...
					<div class="list" id="nmno">
						<a href="#" onclick="return false;" class="btn btn-switch"
							...
							class="onoffswitch-title-desc">Removes mesh on menu reveal</span>
					</div>
					...
					<div class="list" id="mhc">
						<a href="#" onclick="return false;" class="btn btn-switch"
							...
							class="onoffswitch-title">High Contrast Text (WCAG 2 AA)</span> <span
							class="onoffswitch-title-desc">4.5:1 text contrast ratio</span>
					</div>
				...
				<div class="expanded theme-colors pl-5 pr-3">
					<ul class="m-0">
						...
						<li><a href="#" id="myapp-1" data-action="theme-update"
							data-themesave
							data-theme="/resources/dist/css/themes/cust-theme-1.css"
						...
						<li><a href="#" id="myapp-2" data-action="theme-update"
							data-themesave
							data-theme="/resources/dist/css/themes/cust-theme-2.css"
						...
						<li><a href="#" id="myapp-3" data-action="theme-update"
							data-themesave
							data-theme="/resources/dist/css/themes/cust-theme-3.css"
						...
						<li><a href="#" id="myapp-4" data-action="theme-update"
							data-themesave
							data-theme="/resources/dist/css/themes/cust-theme-4.css"
						...
						<li><a href="#" id="myapp-5" data-action="theme-update"
							data-themesave
							data-theme="/resources/dist/css/themes/cust-theme-5.css"
						...
						<li><a href="#" id="myapp-6" data-action="theme-update"
							data-themesave
							data-theme="/resources/dist/css/themes/cust-theme-6.css"
						...
						<li><a href="#" id="myapp-7" data-action="theme-update"
							data-themesave
							data-theme="/resources/dist/css/themes/cust-theme-7.css"
						...
						<li><a href="#" id="myapp-8" data-action="theme-update"
							data-themesave
							data-theme="/resources/dist/css/themes/cust-theme-8.css"
						...
						<li><a href="#" id="myapp-9" data-action="theme-update"
							data-themesave
							data-theme="/resources/dist/css/themes/cust-theme-9.css"
						...
						<li><a href="#" id="myapp-10" data-action="theme-update"
							data-themesave
							data-theme="/resources/dist/css/themes/cust-theme-10.css"
						...
						<li><a href="#" id="myapp-11" data-action="theme-update"
							data-themesave
							data-theme="/resources/dist/css/themes/cust-theme-11.css"
						...
						<li><a href="#" id="myapp-14" data-action="theme-update"
							data-themesave
							data-theme="/resources/dist/css/themes/cust-theme-14.css"
						...
						<li><a href="#" id="myapp-15" data-action="theme-update"
							data-themesave
							data-theme="/resources/dist/css/themes/cust-theme-15.css"
						...
						<div id="skin-default" data-action="toggle-replace"
							...
							<div class="d-flex flex-column flex-1">
								...
								<div class="bg-faded flex-1 pt-3 pb-3 px-2">
									<div class="py-3"
										style="background: url('/resources/dist/img/demo/s-1.png') top left no-repeat; background-size: 100%;"></div>
								</div>
							</div>
						</div>
						Default
